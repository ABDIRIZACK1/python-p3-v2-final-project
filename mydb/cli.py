...
def add_transfer(args):
    database.add_transfer(args.player_id, args.from_team_id, args.to_team_id, args.date
, args.fee)
    print(f"Transfer added successfully.")
...
def main_menu():
    ...
    parser_add_transfer.add_argument('player_id', type=int, help='ID of the player')
    parser_add_transfer.add_argument('from_team_id', type=int, help='ID of the current team')
    parser_add_transfer.add_argument('to_team_id', type=int, help='ID of the new team')
